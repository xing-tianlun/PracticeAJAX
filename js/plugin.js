(function () {
  Object.assign(xtl.plugin, {
    ...
    config: {
      ...
      ARROW_C: '<span name="minus">-</span><input type="text" value="1" name="count" /><span name="add">+</span><span style="display:none;" name="desc">件(库存<label name="num">%num%</label>件)</span></span>',
